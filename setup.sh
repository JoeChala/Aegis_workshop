...
if ls ghidra_* 1> /dev/null 2>&1; then
    echo -e "\033[1;32m Ghidra is already installed. Skipping download.\033[0m"
else
    echo -e "\033[1;36m Downloading Ghidra				        [4/7]\033[0m"
    mkdir -p ~/workshop/tools
    cd ~/workshop/tools
    wget https://github.com/NationalSecurityAgency/ghidra/releases/download/Ghidra_11.3.2_build/ghidra_11.3.2_PUBLIC_20250415.zip  -o ghidra_11.3.2.zip

    echo -e "\033[1;36m Extracting Ghidra...				       [5/7]\033[0m"
    unzip ghidra_11.3.2.zip
    rm ghidra_11.3.2.zip
fi
